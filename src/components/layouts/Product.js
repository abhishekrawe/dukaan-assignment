...
<div className="container my-5">   
             <div className="row">
               <div className="col-lg-4 d-flex flex-column justify-content-center align-items-center">
                 <img className="mb-3" src="asset/frp.svg" alt="Generic placeholder image" width="48" height="48"/>
                 <h2>Search </h2>
               ...
               <div className="col-lg-4 d-flex flex-column justify-content-center align-items-center">
                 <img className="mb-3" src="asset/grp.svg" alt="Generic placeholder image" width="56" height="48"/>
                 <h2>Select</h2>
                 <p className="w-75 text-center">Choose from thousands of options generated by the slogan maker that fit your needs..</p>
          
               </div>
               <div className="col-lg-4 d-flex flex-column justify-content-center align-items-center">
                 <img className="mb-3" src="asset/srp.svg" alt="Generic placeholder image" width="65" height="65"/>
                 <h2>Stand out</h2>
